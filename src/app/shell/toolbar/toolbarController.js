...
.controller('ToolbarController', function ($scope, $state, $rootScope) {
	...
	$scope.onResourceSearch = $rootScope.$state.current.name === 'owm.resource.search.list' ? true : false;
	...
	$rootScope.$on('$stateChangeSuccess', function (event, toState) {
		...
		$scope.onResourceSearch = toState.name === 'owm.resource.search.list' ? true : false;
	});
